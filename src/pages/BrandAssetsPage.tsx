        ...
        <div className="flex flex-col gap-16">
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link to="/thumbnail?v=a" className="block rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <Link to="/thumbnail?v=b" className="block rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                <div className="w-full aspect-[1200/630] overflow-hidden">
                  <div className="origin-top-left scale-[0.3] md:scale-[0.4]">
              ...
              <Link to="/thumbnail?v=c" className="block rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                <div className="w-full aspect-[1200/630] overflow-hidden">
                  <div className="origin-top-left scale-[0.3] md:scale-[0.4]">
          ...
          <section>
            ...
            <Link to="/og-preview" className="block rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow max-w-lg">
              <div className="w-full aspect-[1200/630] overflow-hidden">
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-8">
              <Link to="/apple-touch-preview" className="flex flex-col items-center gap-3">
              ...
              <Link to="/favicon-preview" className="flex flex-col items-center gap-3">
